...
8. **NEVER start Codex inside your OpenClaw state directory** (`$OPENCLAW_STATE_DIR`, default `~/.soloclaw`) - it'll read your soul docs and get weird ideas about the org chart!
