...
type ExecToolConfig = NonNullable<NonNullable<SoloClawConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<SoloClawConfig> {
  if (opts.loadConfig) {
