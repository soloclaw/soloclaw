...
describe("debug proxy runtime", () => {
  const envKeys = [
    ...
    "SOLOCLAW_DEBUG_PROXY_SOURCE_PROCESS",
  ] as const;
  ...
  beforeEach(() => {
    ...
    process.env.SOLOCLAW_DEBUG_PROXY_ENABLED = "1";
    process.env.SOLOCLAW_DEBUG_PROXY_DB_PATH = "/tmp/openclaw-proxy-runtime-test.sqlite";
    process.env.SOLOCLAW_DEBUG_PROXY_BLOB_DIR = "/tmp/openclaw-proxy-runtime-test-blobs";
    process.env.SOLOCLAW_DEBUG_PROXY_SESSION_ID = "runtime-test-session";
    process.env.SOLOCLAW_DEBUG_PROXY_SOURCE_PROCESS = "runtime-test";
  });
