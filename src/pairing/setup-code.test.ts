...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("SOLOCLAW_GATEWAY_TOKEN", "");
    vi.stubEnv("SOLOCLAW_GATEWAY_PASSWORD", "");
    vi.stubEnv("SOLOCLAW_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses SOLOCLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          SOLOCLAW_GATEWAY_TOKEN: "new-token",
        },
