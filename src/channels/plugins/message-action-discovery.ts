...
export function listChannelMessageActions(cfg: SoloClawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: SoloClawConfig): ChannelMessageCapability[] {
