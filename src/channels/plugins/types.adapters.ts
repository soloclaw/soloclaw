...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: SoloClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: SoloClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: SoloClawConfig) => string;
  ...
  isEnabled?: BivariantCallback<(account: ResolvedAccount, cfg: SoloClawConfig) => boolean>;
  disabledReason?: BivariantCallback<(account: ResolvedAccount, cfg: SoloClawConfig) => string>;
  isConfigured?: BivariantCallback<
    (account: ResolvedAccount, cfg: SoloClawConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: BivariantCallback<(account: ResolvedAccount, cfg: SoloClawConfig) => string>;
  describeAccount?: BivariantCallback<
    (account: ResolvedAccount, cfg: SoloClawConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: SoloClawConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: SoloClawConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: BivariantCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: SoloClawConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.soloclaw.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: SoloClawConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: SoloClawConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: SoloClawConfig;
    nextCfg: SoloClawConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: SoloClawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: SoloClawConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: SoloClawConfig; accountId?: string | null }) =>
    | {
