...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: SoloClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: SoloClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: SoloClawConfig): string {
