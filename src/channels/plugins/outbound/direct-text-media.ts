import { sanitizeForPlainText } from "soloclaw/plugin-sdk/outbound-runtime";
import {
...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: SoloClawConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: SoloClawConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: string) {
  return (params: { cfg: SoloClawConfig; accountId?: string | null }) =>
