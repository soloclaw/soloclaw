...
describe("resolveOutboundSessionRoute", () => {
  ...
  const perChannelPeerCfg = { session: { dmScope: "per-channel-peer" } } as SoloClawConfig;
  ...
  const perChannelPeerSessionCfg = { session: { dmScope: "per-channel-peer" } } as SoloClawConfig;
