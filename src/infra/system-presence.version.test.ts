  ...
  return withEnvAsync(
    {
      ...
      SOLOCLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when SOLOCLAW_VERSION is not set", async () => {
  ...
  it("prefers SOLOCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over SOLOCLAW_SERVICE_VERSION when SOLOCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        SOLOCLAW_VERSION: " ",
        SOLOCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when SOLOCLAW_VERSION and SOLOCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        SOLOCLAW_VERSION: " ",
        SOLOCLAW_SERVICE_VERSION: "\t",
