  ...
  it.each([
    {
      ...
      expected: [
        ...
        "- state: ~/.soloclaw",
        "Skipped 1 path:",
        "- workspace: ~/Projects/openclaw (covered by ~/.soloclaw)",
        ...
        assets: [
          {
            ...
            displayPath: "~/.soloclaw/config.json",
          },
          {
            kind: "credentials",
            sourcePath: "/oauth",
            archivePath: "archive/oauth",
            displayPath: "~/.soloclaw/oauth",
          },
        ],
      }),
      expected: [
        backupArchiveLine,
        "Included 2 paths:",
        "- config: ~/.soloclaw/config.json",
        "- credentials: ~/.soloclaw/oauth",
