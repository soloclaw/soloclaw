...
export function isAcpEnabledByPolicy(cfg: SoloClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: SoloClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: SoloClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: SoloClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: SoloClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: SoloClawConfig, agentId: string): boolean {
