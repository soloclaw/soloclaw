...
type ConfiguredBinding = NonNullable<SoloClawConfig["bindings"]>[number];
...
function createCfgWithBindings(
  ...
  overrides?: Partial<SoloClawConfig>,
): SoloClawConfig {
  return {
    ...baseCfg,
    ...overrides,
...
function resolveBindingRecord(cfg: SoloClawConfig, overrides: Partial<BindingRecordInput> = {}) {
