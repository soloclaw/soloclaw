...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: SoloClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: SoloClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: SoloClawConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: SoloClawConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: SoloClawConfig }): Promise<void> {
