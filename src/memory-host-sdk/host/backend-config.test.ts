...
function resolveCollectionNamesForAgent(cfg: SoloClawConfig, agentId: string): Set<string> {
  return new Set(
...
function resolveCustomCollectionPathsForAgent(cfg: SoloClawConfig, agentId: string): string[] {
...
describe("resolveMemoryBackendConfig", () => {
  it("defaults to builtin backend when config missing", () => {
    const cfg = { agents: { defaults: { workspace: "/tmp/memory-test" } } } as SoloClawConfig;
