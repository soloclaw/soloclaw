...
export function applyGoogleGeminiModelDefault(cfg: SoloClawConfig): {
  next: SoloClawConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: SoloClawConfig): SoloClawConfig {
...
export function applyOpenAIConfig(cfg: SoloClawConfig): SoloClawConfig {
...
export function applyOpencodeGoModelDefault(cfg: SoloClawConfig): {
  next: SoloClawConfig;
  changed: boolean;
} {
