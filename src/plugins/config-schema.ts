...
import type { SoloClawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: SoloClawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): SoloClawPluginConfigSchema {
  return {
