...
function resolveGatewayStartupDreamingPluginIds(config: SoloClawConfig): Set<string> {
...
function resolveExplicitMemorySlotStartupPluginId(config: SoloClawConfig): string | undefined {
