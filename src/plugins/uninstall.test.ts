...
type PluginConfig = NonNullable<SoloClawConfig["plugins"]>;
...
function createPluginConfig(params: {
  ...
  loadPaths?: string[];
  channels?: SoloClawConfig["channels"];
}): SoloClawConfig {
...
function createSinglePluginWithEmptySlotsConfig(): SoloClawConfig {
...
function createSingleNpmInstallConfig(installPath: string): SoloClawConfig {
  return createPluginConfig({
    entries: createSinglePluginEntries(),
    installs: {
