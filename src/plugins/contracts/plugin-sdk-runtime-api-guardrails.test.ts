...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type SoloClawConfig } from "soloclaw/plugin-sdk/core";',
      'export { buildChannelConfigSchema, IMessageConfigSchema } from "./config-api.js";',
      'export { PAIRING_APPROVED_MESSAGE } from "soloclaw/plugin-sdk/channel-status";',
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "soloclaw/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "soloclaw/plugin-sdk/channel-config-helpers";',
      'export { resolveIMessageConfigAllowFrom, resolveIMessageConfigDefaultTo } from "./src/config-accessors.js";',
      'export { looksLikeIMessageTargetId, normalizeIMessageMessagingTarget } from "./src/normalize.js";',
      'export { resolveChannelMediaMaxBytes } from "soloclaw/plugin-sdk/media-runtime";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiSoloClawConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "soloclaw/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "soloclaw/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "soloclaw/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "soloclaw/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "soloclaw/plugin-sdk/channel-lifecycle";',
    'export { createChannelPairingController } from "soloclaw/plugin-sdk/channel-pairing";',
    'export { createChannelReplyPipeline } from "soloclaw/plugin-sdk/channel-reply-pipeline";',
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "soloclaw/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "soloclaw/plugin-sdk/channel-status";',
    'export { chunkTextForOutbound } from "soloclaw/plugin-sdk/text-chunking";',
    'export type { SoloClawConfig } from "soloclaw/plugin-sdk/config-runtime";',
    'export { GROUP_POLICY_BLOCKED_LABEL, isDangerousNameMatchingEnabled, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "soloclaw/plugin-sdk/config-runtime";',
    'export { fetchRemoteMedia, resolveChannelMediaMaxBytes } from "soloclaw/plugin-sdk/media-runtime";',
    ...
    'export { fetchWithSsrFGuard } from "soloclaw/plugin-sdk/ssrf-runtime";',
    'export { GoogleChatConfigSchema, type GoogleChatAccountConfig, type GoogleChatConfig } from "soloclaw/plugin-sdk/googlechat-runtime-shared";',
    'export { extractToolSend } from "soloclaw/plugin-sdk/tool-send";',
    'export { resolveInboundMentionDecision } from "soloclaw/plugin-sdk/channel-inbound";',
    'export { resolveInboundRouteEnvelopeBuilderWithRuntime } from "soloclaw/plugin-sdk/inbound-envelope";',
    'export { resolveWebhookPath } from "soloclaw/plugin-sdk/webhook-path";',
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "soloclaw/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "soloclaw/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "soloclaw/plugin-sdk/ssrf-runtime";',
    ...
    'export { writeJsonFileAtomically } from "soloclaw/plugin-sdk/json-store";',
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, SoloClawConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "soloclaw/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "soloclaw/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile({
    ...
    'export * from "soloclaw/plugin-sdk/nextcloud-talk";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { SoloClawPluginService, SoloClawPluginServiceContext, PluginLogger } from "soloclaw/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "soloclaw/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "soloclaw/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "soloclaw/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "soloclaw/plugin-sdk/channel-plugin-common";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "soloclaw/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "soloclaw/plugin-sdk/channel-actions";',
      ...
      'export type { SoloClawConfig } from "soloclaw/plugin-sdk/config-runtime";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeSoloClawConfig["channels"]>["telegram"] >;',
