  ...
  it.each([
    {
      ...
      expected: {
        ...
        error:
          'Plugin "demo" requires plugin API >=2026.3.22, but this SoloClaw runtime exposes 2026.3.21.',
      },
    },
    {
      ...
      expected: {
        ...
        error: '"calendar" is a skill. Use "soloclaw skills install calendar" instead.',
      },
    },
    {
