...
export function applyProviderAuthConfigPatch(cfg: SoloClawConfig, patch: unknown): SoloClawConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: patchModels as NonNullable<
          NonNullable<SoloClawConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  };
...
export function applyDefaultModel(cfg: SoloClawConfig, model: string): SoloClawConfig {
