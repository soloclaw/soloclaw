...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveSoloClawAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: SoloClawConfig): SecretRef {
