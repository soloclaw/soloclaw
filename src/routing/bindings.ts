...
export function listBindings(cfg: SoloClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: SoloClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SoloClawConfig) {
