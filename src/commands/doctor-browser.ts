...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: SoloClawConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: SoloClawConfig, deps?: BrowserDoctorDeps) {
  try {
