...
import type { SoloClawConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: SoloClawConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
export function buildNetworkHints(cfg: SoloClawConfig) {
