...
type SetupCommandDeps = {
  ...
  writeConfigFile?: (config: SoloClawConfig) => Promise<void>;
};
...
async function writeDefaultConfigFile(config: SoloClawConfig): Promise<void> {
