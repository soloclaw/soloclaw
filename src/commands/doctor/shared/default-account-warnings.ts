...
export function collectMissingDefaultAccountBindingWarnings(cfg: SoloClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: SoloClawConfig): string[] {
  const warnings: string[] = [];
