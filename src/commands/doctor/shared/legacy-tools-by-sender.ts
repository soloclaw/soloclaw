...
export function scanLegacyToolsBySenderKeys(cfg: SoloClawConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: SoloClawConfig): {
