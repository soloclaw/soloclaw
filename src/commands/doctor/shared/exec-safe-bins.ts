...
function collectExecSafeBinScopes(cfg: SoloClawConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: SoloClawConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: SoloClawConfig): {
