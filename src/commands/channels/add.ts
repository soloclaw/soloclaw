...
import { replaceConfigFile, type SoloClawConfig } from "../../config/config.js";
...
async function resolveCatalogChannelEntry(raw: string, cfg: SoloClawConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as SoloClawConfig;
  ...
  // May trigger loadSoloClawPlugins on cache miss (disk scan + jiti import)
