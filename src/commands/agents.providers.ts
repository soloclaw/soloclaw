...
function resolveDefaultAccountId(cfg: SoloClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SoloClawConfig): boolean {
...
export function summarizeBindings(cfg: SoloClawConfig, bindings: AgentBinding[]): string[] {
