...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("soloclaw tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("soloclaw tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: SoloClawConfig) {
