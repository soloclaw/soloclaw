...
function resolveMentionPatterns(cfg: SoloClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SoloClawConfig | undefined, agentId?: string): RegExp[] {
