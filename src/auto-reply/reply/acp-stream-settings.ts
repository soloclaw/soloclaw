...
function resolveAcpStreamCoalesceIdleMs(cfg: SoloClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: SoloClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: SoloClawConfig): AcpProjectionSettings {
