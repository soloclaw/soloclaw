...
function getDiscordExecApprovalApproversForTests(params: { cfg: SoloClawConfig }): string[] {
...
function listConfiguredTelegramAccountIds(cfg: SoloClawConfig): string[] {
...
const telegramApproveTestPlugin: ChannelPlugin = {
  ...createChannelTestPluginBase({
    ...
    config: {
      listAccountIds: listConfiguredTelegramAccountIds,
      resolveAccount: (cfg: SoloClawConfig, accountId?: string | null) =>
        resolveTelegramTestAccount(cfg, accountId),
      defaultAccountId: (cfg: SoloClawConfig) =>
