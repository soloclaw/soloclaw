...
function setTempHomeEnv(home: string): void {
  ...
  process.env.SOLOCLAW_STATE_DIR = join(home, ".soloclaw");
...
export async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  ...
  await fs.mkdir(join(home, ".soloclaw", "agents", "main", "sessions"), { recursive: true });
  setTempHomeEnv(home);
...
export function makeCfg(home: string): SoloClawConfig {
