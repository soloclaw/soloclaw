    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["soloclaw channels list", "List configured channels and auth profiles."],
          ["soloclaw channels status --probe", "Run channel status checks and probes."],
          [
            "soloclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["soloclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.soloclaw.ai/cli/channels",
        )}\n`,
    );
