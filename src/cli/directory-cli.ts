    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["soloclaw directory self --channel slack", "Show the connected account identity."],
          [
            'openclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["soloclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "soloclaw directory groups members --channel discord --group-id <id>",
