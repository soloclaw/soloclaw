      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["soloclaw gateway run", "Run the gateway in the foreground."],
            ["soloclaw gateway status", "Show service status and probe reachability."],
            ["soloclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["soloclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.soloclaw.ai/cli/gateway")}\n`,
      ),
  );
