...
${formatHelpExamples([
  ['soloclaw message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'soloclaw message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'soloclaw message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.soloclaw.ai/cli/message")}`,
    )
    .action(() => {
