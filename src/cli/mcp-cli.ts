...
import { serveSoloClawChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage SoloClaw MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose SoloClaw channels over MCP stdio")
