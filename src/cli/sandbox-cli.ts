...
const SANDBOX_EXAMPLES = {
  main: [
    ["soloclaw sandbox list", "List all sandbox containers."],
    ["soloclaw sandbox list --browser", "List only browser containers."],
    ["soloclaw sandbox recreate --all", "Recreate all containers."],
    ["soloclaw sandbox recreate --session main", "Recreate a specific session."],
    ["soloclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["soloclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["soloclaw sandbox list", "List all sandbox containers."],
    ["soloclaw sandbox list --browser", "List only browser containers."],
    ["soloclaw sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["soloclaw sandbox recreate --all", "Recreate all containers."],
    ["soloclaw sandbox recreate --session main", "Recreate a specific session."],
    ["soloclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["soloclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["soloclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["soloclaw sandbox explain", "Show effective sandbox config."],
    ["soloclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["soloclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["soloclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.soloclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
