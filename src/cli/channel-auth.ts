...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: SoloClawConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: SoloClawConfig, mode: ChannelAuthMode): string {
