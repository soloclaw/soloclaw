...
export function hasAmbiguousGatewayAuthModeConfig(cfg: SoloClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: SoloClawConfig): void {
