...
export function setPluginSubagentOverridePolicies(cfg: SoloClawConfig): void {
  ...
  if (!policy?.allowModelOverride) {
    return {
      ...
      reason:
        ...
        "See https://docs.soloclaw.ai/tools/plugin#runtime-helpers and search for: " +
...
export function loadGatewayPlugins(params: {
  ...
  const pluginRegistry = loadSoloClawPlugins({
    config: resolvedConfig,
