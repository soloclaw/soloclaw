...
const ensureSoloClawModelsJsonMock = vi.fn<
...
vi.mock("../agents/agent-paths.js", () => ({
  resolveSoloClawAgentDir: () => "/tmp/agent",
}));

vi.mock("../agents/models-config.js", () => ({
  ensureSoloClawModelsJson: (config: unknown, agentDir: unknown) =>
    ensureSoloClawModelsJsonMock(config, agentDir),
}));
...
describe("gateway startup primary model warmup", () => {
  ...
  beforeEach(() => {
    ensureSoloClawModelsJsonMock.mockClear();
  ...
  it("prewarms an explicit configured primary model", async () => {
    ...
    expect(ensureSoloClawModelsJsonMock).toHaveBeenCalledWith(cfg, "/tmp/agent");
  ...
  it("skips warmup when no explicit primary model is configured", async () => {
    ...
    expect(ensureSoloClawModelsJsonMock).not.toHaveBeenCalled();
