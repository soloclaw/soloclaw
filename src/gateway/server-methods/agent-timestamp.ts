 ...
 *
 * @see https://github.com/soloclaw/soloclaw/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an SoloClawConfig.
 */
export function timestampOptsFromConfig(cfg: SoloClawConfig): TimestampInjectionOptions {
  return {
