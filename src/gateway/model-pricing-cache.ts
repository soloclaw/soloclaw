...
export function collectConfiguredModelPricingRefs(config: SoloClawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: SoloClawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
