...
export function resolveHooksConfig(cfg: SoloClawConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: SoloClawConfig, defaultAgentId: string): Set<string> {
