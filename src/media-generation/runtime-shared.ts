...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: SoloClawConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: SoloClawConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: SoloClawConfig;
  agentDir?: string;
  listProviders: (cfg?: SoloClawConfig) => CapabilityProviderCandidate[];
}): string[] {
