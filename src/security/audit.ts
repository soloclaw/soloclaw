...
import type { ConfigFileSnapshot, SoloClawConfig } from "../config/config.js";
...
export function collectLoggingFindings(cfg: SoloClawConfig): SecurityAuditFinding[] {
...
export function collectElevatedFindings(cfg: SoloClawConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
export function collectExecRuntimeFindings(cfg: SoloClawConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
function collectOpenExecSurfacePaths(cfg: SoloClawConfig): string[] {
