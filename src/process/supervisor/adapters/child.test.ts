...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.SOLOCLAW_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.SOLOCLAW_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.SOLOCLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
