...
import type { SoloClawPluginApi } from "../plugins/types.js";
...
export type { SoloClawPluginToolContext, SoloClawPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: SoloClawConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
