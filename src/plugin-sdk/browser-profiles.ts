...
import type { BrowserConfig, BrowserProfileConfig, SoloClawConfig } from "../config/config.js";
...
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredSoloClawTmpDir(), "uploads");
