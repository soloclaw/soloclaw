...
export type TtsRuntimeFacade = {
  _test: TtsTestFacade;
  buildTtsSystemPromptHint: (cfg: SoloClawConfig) => string | undefined;
  ...
  resolveTtsConfig: (cfg: SoloClawConfig) => ResolvedTtsConfig;
  resolveTtsPrefsPath: (config: ResolvedTtsConfig) => string;
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: SoloClawConfig) => TtsProvider[];
