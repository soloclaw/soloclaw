...
let originalSoloClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalSoloClawTestConsole = process.env.SOLOCLAW_TEST_CONSOLE;
...
afterEach(() => {
  ...
  if (originalSoloClawTestConsole === undefined) {
    delete process.env.SOLOCLAW_TEST_CONSOLE;
  } else {
    process.env.SOLOCLAW_TEST_CONSOLE = originalSoloClawTestConsole;
  }
