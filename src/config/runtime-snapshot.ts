...
let runtimeConfigSnapshot: SoloClawConfig | null = null;
let runtimeConfigSourceSnapshot: SoloClawConfig | null = null;
...
export function getRuntimeConfigSourceSnapshot(): SoloClawConfig | null {
...
export function loadPinnedRuntimeConfig(loadFresh: () => SoloClawConfig): SoloClawConfig {
...
export async function finalizeRuntimeSnapshotWrite(params: {
  nextSourceConfig: SoloClawConfig;
