...
export function applyMessageDefaults(cfg: SoloClawConfig): SoloClawConfig {
...
export function applyTalkConfigNormalization(config: SoloClawConfig): SoloClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: SoloClawConfig): SoloClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SoloClawConfig): SoloClawConfig {
...
export function applyLoggingDefaults(cfg: SoloClawConfig): SoloClawConfig {
...
export function applyContextPruningDefaults(cfg: SoloClawConfig): SoloClawConfig {
...
export function applyCompactionDefaults(cfg: SoloClawConfig): SoloClawConfig {
