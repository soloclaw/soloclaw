...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.SOLOCLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.SOLOCLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.SOLOCLAW_WATCH_COMMAND),
