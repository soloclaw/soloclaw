...
function buildNoVideoGenerationModelConfiguredMessage(cfg: SoloClawConfig): string {
...
export function listRuntimeVideoGenerationProviders(params?: { config?: SoloClawConfig }) {
