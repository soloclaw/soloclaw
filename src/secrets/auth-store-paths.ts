...
export function listAuthProfileStorePaths(config: SoloClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: SoloClawConfig, stateDir: string): string[] {
