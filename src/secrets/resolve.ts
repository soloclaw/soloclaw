...
function resolveResolutionLimits(config: SoloClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: SoloClawConfig): SecretProviderConfig {
