...
function buildNoImageGenerationModelConfiguredMessage(cfg: SoloClawConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: SoloClawConfig }) {
