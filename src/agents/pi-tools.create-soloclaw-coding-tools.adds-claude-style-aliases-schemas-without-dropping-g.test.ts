...
import { createSoloClawReadTool, createSandboxedReadTool } from "./pi-tools.read.js";
...
describe("createSoloClawCodingTools read behavior", () => {
  ...
  it("strips truncation.content details from read results while preserving other fields", async () => {
    ...
    const wrapped = createSoloClawReadTool(
      baseRead as unknown as Parameters<typeof createSoloClawReadTool>[0],
    );
