...
const SOLOCLAW_CLAUDE_PLUGIN_NAME = "openclaw-skills";
...
export async function prepareClaudeCliSkillsPlugin(params: {
  ...
  const manifest = {
    name: SOLOCLAW_CLAUDE_PLUGIN_NAME,
    version: "0.0.0",
    description: "Session-scoped SoloClaw skills selected for this agent run.",
    skills: "./skills",
  };
  await fs.writeFile(
