...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<SoloClawConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<SoloClawConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: SoloClawConfig): WebSearchConfig {
