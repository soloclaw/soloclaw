...
function resolveAdaptiveReadMaxBytes(options?: SoloClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSoloClawReadTool(base, {
...
export function createSoloClawReadTool(
  base: AnyAgentTool,
  options?: SoloClawReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
