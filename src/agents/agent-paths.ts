...
export function resolveSoloClawAgentDir(env: NodeJS.ProcessEnv = process.env): string {
...
export function ensureSoloClawAgentEnv(): string {
  const dir = resolveSoloClawAgentDir();
