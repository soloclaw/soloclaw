...
import { createSoloClawCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const toolsRaw = params.disableTools
      ? []
      : (() => {
          const allTools = createSoloClawCodingTools({
            agentId: sessionAgentId,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/soloclaw/soloclaw/issues/9282
      ...
      // See: https://github.com/soloclaw/soloclaw/issues/8643
