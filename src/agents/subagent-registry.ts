...
type SubagentRegistryDeps = {
  ...
  resolveContextEngine?: (cfg: SoloClawConfig) => Promise<ContextEngine>;
};
...
async function resolveSubagentRegistryContextEngine(cfg: SoloClawConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: SoloClawConfig, runTimeoutSeconds?: number) {
