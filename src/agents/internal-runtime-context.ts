export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_SOLOCLAW_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_SOLOCLAW_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[SOLOCLAW_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[SOLOCLAW_INTERNAL_CONTEXT_END]]";
