...
function isTranscriptOnlySoloClawAssistantMessage(message: AgentMessage | undefined): boolean {
...
export function handleMessageStart(
  ...
  if (msg?.role !== "assistant" || isTranscriptOnlySoloClawAssistantMessage(msg)) {
    return;
  }
