...
export function resolveSubagentToolPolicy(cfg?: SoloClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: SoloClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: SoloClawConfig["tools"];
