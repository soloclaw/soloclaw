...
function resolveAllowedFallbacks(params: { cfg: SoloClawConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: SoloClawConfig }): ModelCatalogEntry[] {
