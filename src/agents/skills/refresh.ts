...
function resolveWatchPaths(workspaceDir: string, config?: SoloClawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: SoloClawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SoloClawConfig }) {
