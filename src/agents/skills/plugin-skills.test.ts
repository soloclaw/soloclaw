    ...
    plugins: [
      {
        ...
        manifestPath: path.join(params.acpxRoot, "soloclaw.plugin.json"),
      },
      {
        id: "helper",
        name: "Helper",
        ...
        manifestPath: path.join(params.helperRoot, "soloclaw.plugin.json"),
      },
    ],
  };
}
    ...
    plugins: [
      {
        ...
        manifestPath: path.join(params.pluginRoot, "soloclaw.plugin.json"),
      },
    ],
  };
}
