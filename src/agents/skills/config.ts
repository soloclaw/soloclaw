...
export function isConfigPathTruthy(config: SoloClawConfig | undefined, pathStr: string): boolean {
...
export function resolveBundledAllowlist(config?: SoloClawConfig): string[] | undefined {
