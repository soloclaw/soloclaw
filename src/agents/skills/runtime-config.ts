...
function hasConfiguredSkillApiKeyRef(config?: SoloClawConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: SoloClawConfig): SoloClawConfig | undefined {
