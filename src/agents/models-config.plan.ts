...
type ModelsConfig = NonNullable<SoloClawConfig["models"]>;
...
export async function planSoloClawModelsJsonWithDeps(
  params: {
    cfg: SoloClawConfig;
...
export async function planSoloClawModelsJson(
  params: Parameters<typeof planSoloClawModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planSoloClawModelsJsonWithDeps(params);
}
