...
describe("plugin activation boundary", () => {
  ...
  let browserHelpersPromise:
    | Promise<{
        ...
        DEFAULT_SOLOCLAW_BROWSER_COLOR: typeof import("./plugin-sdk/browser-config.js").DEFAULT_SOLOCLAW_BROWSER_COLOR;
        DEFAULT_SOLOCLAW_BROWSER_PROFILE_NAME: typeof import("./plugin-sdk/browser-config.js").DEFAULT_SOLOCLAW_BROWSER_PROFILE_NAME;
  ...
  function importBrowserHelpers() {
    browserHelpersPromise ??= Promise.all([
      ...
      DEFAULT_SOLOCLAW_BROWSER_COLOR: config.DEFAULT_SOLOCLAW_BROWSER_COLOR,
      DEFAULT_SOLOCLAW_BROWSER_PROFILE_NAME: config.DEFAULT_SOLOCLAW_BROWSER_PROFILE_NAME,
