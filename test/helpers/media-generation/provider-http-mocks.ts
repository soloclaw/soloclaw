import type { resolveProviderHttpRequestConfig } from "soloclaw/plugin-sdk/provider-http";
...
vi.mock("soloclaw/plugin-sdk/provider-auth-runtime", () => ({
  resolveApiKeyForProvider: providerHttpMocks.resolveApiKeyForProviderMock,
}));

vi.mock("soloclaw/plugin-sdk/provider-http", () => ({
