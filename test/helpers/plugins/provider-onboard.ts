...
} from "soloclaw/plugin-sdk/provider-onboard";
import type { ModelApi } from "soloclaw/plugin-sdk/provider-onboard";
...
export function expectProviderOnboardAllowlistAlias(params: {
  applyProviderConfig: (config: SoloClawConfig) => SoloClawConfig;
  modelRef: string;
  alias: string;
}) {
...
export function expectProviderOnboardPrimaryAndFallbacks(params: {
  applyConfig: (config: SoloClawConfig) => SoloClawConfig;
  modelRef: string;
}) {
