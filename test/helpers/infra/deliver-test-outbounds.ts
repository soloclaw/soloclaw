...
function resolveSignalMaxBytes(cfg: SoloClawConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: SoloClawConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
