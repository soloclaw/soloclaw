...
import { buildPluginConfigSchema, z, type SoloClawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: SoloClawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".soloclaw", "wiki", "main");
}
