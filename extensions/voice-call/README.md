...
Docs: `https://docs.soloclaw.ai/plugins/voice-call`
Plugin system: `https://docs.soloclaw.ai/plugin`
...
```bash
PLUGIN_HOME=~/.soloclaw/extensions
mkdir -p "$PLUGIN_HOME"
...
- advanced webhook, streaming, and tunnel notes: `https://docs.soloclaw.ai/plugins/voice-call`
...
`https://docs.soloclaw.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.soloclaw.ai/plugins/voice-call#tts-for-calls`
