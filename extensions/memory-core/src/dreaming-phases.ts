...
import {
  ...
  sessionPathForFile,
} from "soloclaw/plugin-sdk/memory-core-host-engine-qmd";
...
const LIGHT_SLEEP_EVENT_TEXT = "__soloclaw_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__soloclaw_memory_core_rem_sleep__";
 ...
 */
export function registerMemoryDreamingPhases(_api: SoloClawPluginApi): void {
