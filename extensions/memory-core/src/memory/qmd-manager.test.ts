...
vi.mock("soloclaw/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("soloclaw/plugin-sdk/memory-core-host-engine-foundation")
  >("soloclaw/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
vi.mock("soloclaw/plugin-sdk/file-lock", async () => {
  const actual = await vi.importActual<typeof import("soloclaw/plugin-sdk/file-lock")>(
    "soloclaw/plugin-sdk/file-lock",
  );
  return {
    ...actual,
...
} from "soloclaw/plugin-sdk/memory-core-host-engine-storage";
...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: SoloClawConfig }) {
