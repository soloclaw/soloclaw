import type { ProviderCatalogContext } from "soloclaw/plugin-sdk/provider-catalog-shared";
import type { ModelProviderConfig } from "soloclaw/plugin-sdk/provider-model-shared";
