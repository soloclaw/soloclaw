...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.SOLOCLAW_GATEWAY_PORT;
    process.env.SOLOCLAW_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.SOLOCLAW_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.SOLOCLAW_GATEWAY_PASSWORD;
