...
vi.mock("soloclaw/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("soloclaw/plugin-sdk/routing")>(
...
vi.mock("soloclaw/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("soloclaw/plugin-sdk/agent-runtime")>(
