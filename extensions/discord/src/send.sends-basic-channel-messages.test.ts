...
vi.mock("soloclaw/plugin-sdk/web-media", () => discordWebMediaMockFactory());
...
let loadWebMedia: typeof import("soloclaw/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("soloclaw/plugin-sdk/web-media"));
