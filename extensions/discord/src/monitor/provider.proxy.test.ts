...
vi.mock("soloclaw/plugin-sdk/proxy-capture", () => ({
  ...
  resolveEffectiveDebugProxyUrl: (configuredProxyUrl?: string) =>
    configuredProxyUrl?.trim() || process.env.SOLOCLAW_DEBUG_PROXY_URL,
...
describe("createDiscordGatewayPlugin", () => {
  ...
  beforeEach(() => {
    vi.unstubAllEnvs();
    vi.stubEnv("SOLOCLAW_DEBUG_PROXY_ENABLED", "");
    vi.stubEnv("SOLOCLAW_DEBUG_PROXY_URL", "");
