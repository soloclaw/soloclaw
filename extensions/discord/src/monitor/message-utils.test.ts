...
vi.mock("soloclaw/plugin-sdk/media-runtime", async () => {
  const actual = await vi.importActual<typeof import("soloclaw/plugin-sdk/media-runtime")>(
    "soloclaw/plugin-sdk/media-runtime",
  );
  return {
    ...actual,
