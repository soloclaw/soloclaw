...
type LoadedConfig = ReturnType<typeof import("soloclaw/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("soloclaw/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("soloclaw/plugin-sdk/runtime-env").createSubsystemLogger>;
