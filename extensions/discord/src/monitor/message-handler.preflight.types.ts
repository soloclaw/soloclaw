...
import type { SessionBindingRecord } from "soloclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "soloclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "soloclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("soloclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("soloclaw/plugin-sdk/runtime-env").RuntimeEnv;
