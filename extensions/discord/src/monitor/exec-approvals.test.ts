...
vi.mock("soloclaw/plugin-sdk/approval-gateway-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("soloclaw/plugin-sdk/approval-gateway-runtime")>();
  return {
    ...actual,
