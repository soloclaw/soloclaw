...
vi.mock("soloclaw/plugin-sdk/reply-dispatch-runtime", async () => {
  const actual = await vi.importActual<typeof import("soloclaw/plugin-sdk/reply-dispatch-runtime")>(
...
vi.mock("soloclaw/plugin-sdk/command-status-runtime", () => ({
...
describe("discord native /status", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("soloclaw/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithDispatcher,
    );
