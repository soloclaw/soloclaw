import {
  ...
  summarizeMapping,
} from "soloclaw/plugin-sdk/allow-from";
import type { DiscordGuildEntry } from "soloclaw/plugin-sdk/config-runtime";
...
import { normalizeStringEntries } from "soloclaw/plugin-sdk/text-runtime";
