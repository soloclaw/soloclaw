...
import {
  ...
  type MsgContext,
} from "soloclaw/plugin-sdk/reply-runtime";
...
type LoadConfigFn = typeof import("soloclaw/plugin-sdk/config-runtime").loadConfig;
type LoadSessionStoreFn = typeof import("soloclaw/plugin-sdk/config-runtime").loadSessionStore;
type ResolveStorePathFn = typeof import("soloclaw/plugin-sdk/config-runtime").resolveStorePath;
...
vi.mock("soloclaw/plugin-sdk/web-media", () => ({
  loadWebMedia,
}));
