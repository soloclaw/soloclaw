...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SOLOCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listEnabledTelegramAccounts(cfg: SoloClawConfig): ResolvedTelegramAccount[] {
