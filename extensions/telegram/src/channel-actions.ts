...
import type { TelegramActionConfig } from "soloclaw/plugin-sdk/config-runtime";
import { readStringValue } from "soloclaw/plugin-sdk/text-runtime";
import { extractToolSend } from "soloclaw/plugin-sdk/tool-send";
import {
