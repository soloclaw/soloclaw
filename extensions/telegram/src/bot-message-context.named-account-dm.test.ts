...
let clearRuntimeConfigSnapshot: typeof import("soloclaw/plugin-sdk/config-runtime").clearRuntimeConfigSnapshot;
let setRuntimeConfigSnapshot: typeof import("soloclaw/plugin-sdk/config-runtime").setRuntimeConfigSnapshot;
