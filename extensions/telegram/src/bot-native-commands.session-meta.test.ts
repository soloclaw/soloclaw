...
type ResolveConfiguredBindingRouteFn =
  typeof import("soloclaw/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("soloclaw/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("soloclaw/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("soloclaw/plugin-sdk/conversation-runtime")>(
    "soloclaw/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
