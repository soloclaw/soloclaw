...
import { isTruthyEnvValue } from "soloclaw/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "soloclaw/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "SOLOCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "SOLOCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "SOLOCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable SOLOCLAW_TELEGRAM_DNS_RESULT_ORDER
...
export function resetTelegramNetworkConfigStateForTests(): void {
  // no-op, retained for test API compatibility
}
