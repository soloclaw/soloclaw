...
- Prefer CLI surfaces when they exist (example: auth monitoring uses `soloclaw models status --check`).
...
- `scripts/gh-read run list -R soloclaw/soloclaw`
- `scripts/gh-read api repos/soloclaw/soloclaw/pulls/123`
