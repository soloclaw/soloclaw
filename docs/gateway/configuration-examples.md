...
```json5
{
  agent: { workspace: "~/.soloclaw/workspace" },
...
```json5
{
  ...
  session: {
    ...
    store: "~/.soloclaw/agents/default/sessions/sessions.json",
    maintenance: {
      mode: "warn",
      pruneAfter: "30d",
      maxEntries: 500,
...
```json5
{
  agents: {
    ...
    list: [
      ...
      { id: "docs", workspace: "~/.soloclaw/workspace-docs", skills: ["docs-search"] },
    ],
  },
}
```
