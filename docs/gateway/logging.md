...
- The log file path and level can be configured via `~/.soloclaw/soloclaw.json`:
  - `logging.file`
  - `logging.level`
...
`soloclaw gateway` supports a per-gateway style switch:
