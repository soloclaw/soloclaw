...
- **Where state lives:**
  - Channel/provider state: `~/.soloclaw/credentials/`
...
- Keep `~/.soloclaw/workspace` and `~/.soloclaw/` as “your stuff”; don’t put personal prompts/config into the `openclaw` repo.
...
- [SoloClaw assistant setup](/start/openclaw)
