---
title: "Showcase"
description: "Real-world SoloClaw projects from the community"
summary: "Community-built projects and integrations powered by OpenClaw"
read_when:
  - Looking for real SoloClaw usage examples
...
<div className="showcase-hero">
  ...
  <p className="showcase-lead">
    SoloClaw projects are not toy demos. People are shipping PR review loops, mobile apps, home automation,
  ...
  <div className="showcase-video-card">
    <div className="showcase-video-shell">
      <iframe
        ...
        title="SoloClaw community showcase"
        loading="lazy"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        allowFullScreen
      />
...
OpenCode finishes the change → opens a PR → SoloClaw reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="SoloClaw PR review feedback delivered in Telegram" />
</Card>
...
Asked “Robby” (@openclaw) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).
  ...
  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="SoloClaw building a local wine cellar skill from CSV" />
</Card>
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote SoloClaw instances.
</Card>
...
Claude Code discovered and confirmed the purifier controls, then SoloClaw takes over to manage room air quality.
...
Triggered by a roof camera: ask SoloClaw to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via an SoloClaw persona.
</Card>
...
SoloClaw connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Automated Todoist tasks and had SoloClaw generate the skill directly in Telegram chat.
</Card>
...
<Card title="Clawdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi voice assistant ↔ SoloClaw HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<p className="showcase-section-intro">
  Packaging, deployment, and integrations that make SoloClaw easier to run and extend.
</p>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/openclaw-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  ...
  SoloClaw gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/openclaw/nix-openclaw">
  **@openclaw** • `nix` `packaging` `deployment`
  ...
  Batteries-included nixified SoloClaw configuration for reproducible deployments.
</Card>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with SoloClaw as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the SoloClaw ecosystem.
</Card>
