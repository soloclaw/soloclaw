...
{
  agents: {
    list: [{ id: "support", name: "Support", workspace: "~/.soloclaw/workspace-support" }],
  },
  bindings: [
...
Session stores live under the state directory (default `~/.soloclaw`):

- `~/.soloclaw/agents/<agentId>/sessions/sessions.json`
