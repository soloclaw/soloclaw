...
- Auth profiles (OAuth + API keys + optional value-level refs): `~/.soloclaw/agents/<agentId>/agent/auth-profiles.json`
- Legacy compatibility file: `~/.soloclaw/agents/<agentId>/agent/auth.json`
