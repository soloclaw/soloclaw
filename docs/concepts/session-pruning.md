...
SoloClaw also runs a separate idempotent cleanup for older legacy sessions that
...
SoloClaw auto-enables pruning for Anthropic profiles:
...
If you set explicit values, SoloClaw does not override them.
