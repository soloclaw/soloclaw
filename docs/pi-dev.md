...
- Trigger the agent directly:
  - `pnpm soloclaw agent --message "Hello" --thinking low`
...
State lives under the OpenClaw state directory. Default is `~/.soloclaw`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.
