...
```bash
sudo tccutil reset Accessibility ai.soloclaw.mac
sudo tccutil reset ScreenCapture ai.soloclaw.mac
...
Workaround: move files into the OpenClaw workspace (`~/.soloclaw/workspace`) if you want to avoid per-folder grants.
