...
- `~/.soloclaw/.env` for env-backed provider keys and bot tokens
- `~/.soloclaw/agents/<agentId>/agent/auth-profiles.json` for stored provider OAuth/API-key auth
- `~/.soloclaw/openclaw.json` for behavior config
