---
summary: "CLI reference for `soloclaw system` (system events, heartbeat, presence)"
read_when:
...
openclaw system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$SOLOCLAW_GATEWAY_TOKEN"
