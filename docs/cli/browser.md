---
summary: "CLI reference for `soloclaw browser` (lifecycle, profiles, tabs, actions, state, and debugging)"
read_when:
  - You use `soloclaw browser` and want examples for common tasks
