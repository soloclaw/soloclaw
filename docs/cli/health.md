---
summary: "CLI reference for `soloclaw health` (gateway health snapshot via RPC)"
read_when:
...
- Default `soloclaw health` asks the running gateway for its health snapshot. When the
