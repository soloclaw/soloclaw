...
const SYNTHETIC_TRANSCRIPT_REPAIR_RESULT =
  "[soloclaw] missing tool result in session history; inserted synthetic error result for transcript repair.";
...
export function handleChatEvent(state: ChatState, payload?: ChatEventPayload) {
  ...
  // See https://github.com/soloclaw/soloclaw/issues/1909
