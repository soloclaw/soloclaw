    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="SoloClaw" />
          <div class="login-gate__title">SoloClaw</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="SOLOCLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("soloclaw gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("soloclaw dashboard")}</li>
