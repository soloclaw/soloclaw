...
# SoloClaw Auth Widget for Termux
...
SERVER="${SOLOCLAW_SERVER:-l36}"

# Check auth status
termux-toast "Checking SoloClaw auth..."
...
case "$STATUS" in
    ...
    CLAUDE_EXPIRING|SOLOCLAW_EXPIRING)
...
3. SSH to server and paste key"
    ...
    CLAUDE_EXPIRED|SOLOCLAW_EXPIRED)
...
2. Return here and tap OK to SSH"
                ...
                ;;
            *)
                termux-toast "Warning: SoloClaw won't work until re-auth"
                ;;
        esac
        ;;
