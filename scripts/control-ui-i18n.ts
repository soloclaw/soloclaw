...
const ENV_PROVIDER = "SOLOCLAW_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "SOLOCLAW_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "SOLOCLAW_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "SOLOCLAW_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "SOLOCLAW_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "SOLOCLAW_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "SOLOCLAW_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "SOLOCLAW_CONTROL_UI_I18N_PROMPT_TIMEOUT";
