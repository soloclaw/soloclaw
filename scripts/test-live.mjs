...
const env = {
  ...process.env,
  SOLOCLAW_LIVE_TEST: process.env.SOLOCLAW_LIVE_TEST || "1",
  SOLOCLAW_LIVE_TEST_QUIET: quietOverride ?? process.env.SOLOCLAW_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.SOLOCLAW_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
