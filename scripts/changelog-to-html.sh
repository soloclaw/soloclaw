...
if [[ -z "$version_content" ]]; then
  echo "<h2>SoloClaw $VERSION</h2>"
  echo "<p>Latest SoloClaw update.</p>"
  echo "<p><a href=\"https://github.com/soloclaw/soloclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
