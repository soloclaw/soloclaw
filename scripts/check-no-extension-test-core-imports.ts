...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    ...
    hint: "Use soloclaw/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']openclaw\/plugin-sdk\/test-utils["']/,
    hint: "Use soloclaw/plugin-sdk/testing for the public extension test surface.",
  },
  {
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or soloclaw/plugin-sdk/testing for public surfaces.",
  },
  {
