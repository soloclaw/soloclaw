...
export async function runWatchMain(params = {}) {
  ...
  childEnv.SOLOCLAW_WATCH_MODE = "1";
  childEnv.SOLOCLAW_WATCH_SESSION = watchSession;
  ...
  childEnv.SOLOCLAW_NO_RESPAWN = "1";
  if (deps.args.length > 0) {
    childEnv.SOLOCLAW_WATCH_COMMAND = deps.args.join(" ");
  }
