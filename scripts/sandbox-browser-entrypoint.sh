...
CDP_PORT="${SOLOCLAW_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${SOLOCLAW_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${SOLOCLAW_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${SOLOCLAW_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${SOLOCLAW_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${SOLOCLAW_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${SOLOCLAW_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${SOLOCLAW_BROWSER_NOVNC_PASSWORD:-}"

DISABLE_GRAPHICS_FLAGS="${SOLOCLAW_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${SOLOCLAW_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${SOLOCLAW_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
AUTO_START_TIMEOUT_MS="${SOLOCLAW_BROWSER_AUTO_START_TIMEOUT_MS:-12000}"
...
if [[ -z "${CDP_SOURCE_RANGE}" ]]; then
  ...
  echo "[sandbox-browser] Set SOLOCLAW_BROWSER_CDP_SOURCE_RANGE to an explicit CIDR to enable CDP access." >&2
else
