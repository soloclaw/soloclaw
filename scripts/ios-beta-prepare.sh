...
OPENCLAW_APP_BUNDLE_ID = ai.soloclaw.client
OPENCLAW_SHARE_BUNDLE_ID = ai.soloclaw.client.share
OPENCLAW_ACTIVITY_WIDGET_BUNDLE_ID = ai.soloclaw.client.activitywidget
OPENCLAW_WATCH_APP_BUNDLE_ID = ai.soloclaw.client.watchkitapp
OPENCLAW_WATCH_EXTENSION_BUNDLE_ID = ai.soloclaw.client.watchkitapp.extension
